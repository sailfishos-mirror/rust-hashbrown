...
## [0.16.2](https://github.com/rust-lang/hashbrown/compare/v0.16.1...v0.16.2) - 2026-04-03
...
- Update the MSRV badge in the readme
- Relax MSRV to 1.85.0
- Don't overwrite MIRIFLAGS, for testing
